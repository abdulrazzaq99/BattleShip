...
void UserShip10() {
    ...
    for (int i = 0; i < size; i++) {
        ...
        srand(time(0));
        char choice;
        cout << "Plz enter the orientation for the placement of ships: " << endl;
        cin >> choice;
        if (choice == 'h' || choice == 'H')
            direction = 0;
        else if (choice == 'v' || choice == 'V')
            direction = 1;
        //1 for Vertical Positioning and 0 for Horizontal Positioning.
    AirCarrier:
        cout << "Plz enter the row: ";
        cin >> row;
        cout << "Plz enter the coloumn: ";
        cin >> col;
        int counter = 0;
        if (ShipSize[i] == 5) { //Placement of Air Carrier.
            if (direction == 1 && row <= 5) {
...
void Credits() {
    cout << "-----------------~-~-~-~-ABDUL RAZZAQ-~-~-~-~--------------" << endl;
    cout << "-----------------~-~-~-~-AREEJ KHALID-~-~-~-~--------------" << endl;
